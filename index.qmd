...
-   [^1] vs. Organic debates are outdated and inaccurate dualism.
...
-   For many treatment require multi-professions.
...
-   Suited to help all FND variants (but won't be neccersary for all).

-   Co-morbidities needs to be accounted for.

-   Treating underlying and potentially longstanding distress (e.g., anxiety, depression, trauma).
...
-   Psychology
    ...
    -   Few RCTs have been done in this area.

    -   Systematic reviews support use of psychological treatments in FND [(Gutkin et al., 2021)](https://jnnp.bmj.com/content/jnnp/92/1/36.full.pdf).

    -   Meta-analytic support for seizure reduction [(Carlson & Perry, 2017)](https://pubmed.ncbi.nlm.nih.gov/28063373/).

    -   More recent major RCT found no significant change in seizure frequency [(CODES, 2020)](https://www.thelancet.com/journals/lanpsy/article/PIIS2215-0366(20)30128-0/fulltext).
...
Does psychological treatments work for other outcomes?

And under what Conditions?

![Preliminary results being prepared for publication.](files/img/forest.png)
