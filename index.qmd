...
-   **Learning Disabilities:** High rate of co-morbidity.
...
Difficult at times to distinguish from other conditions. Often leads to problems with:
...
## BioPsychoSocial Model {background-color="white"}
...
-   Brain response wrong to sensory input = error (because of our expectations).

-   Seizure scaffold is what becomes activated (e.g., by arousal, emotions, thoughts).
...
-   Deficits in: emotion processing, self-agency, attention, interoception and inference. Difficulty can break down across any combination of these various areas.
...
-   Difficulties with emotion processing (e.g., panic without panic). Helps to explain patients who don't identify as distressed (e.g., anx/dep).

-   Difficulties with interception (e.g., seeming but not feeling anxious).
...
::: notes
-   Tend to be referred from neurology for psychology.

-   Occasionally patients also have access to other input.
...
-   Patients will miss out if they only recieve psychology, while have other needs.

-   Implications for acceptability.

-   Some people can better in a small number of timely delivered psychology sessions.

-   Smoke without fire. Provide education and skills for identifying and managing seizures however if someone is living in chaotic surroundings; MH comorbid then it is like trying to waft fire.
:::
...
-   **Psychology**
    ...
    -   ≥50% patients achieve seizure reduction [(Carlson & Perry, 2017)](https://pubmed.ncbi.nlm.nih.gov/28063373/).
...
::: notes
-   82% of those completing [psychotherapy](https://www.sciencedirect.com/topics/medicine-and-dentistry/psychotherapy "Learn more about psychotherapy from ScienceDirect's AI-generated Topic Pages") report a reduction in seizures of ≥50%.
-   Not lots known about who doesn't respond; or long-term follow up.
-   This body of evidence suggests that neurocircuitry-based interventions, such as non-invasive brain stimulation techniques (NIBS), may also represent an effective therapeutic option for patients with FND.
:::

## Problems with Measuring Seizures {background-color="white"}

::: columns
::: {.column width="50%"}
-   Not always amenable to change [(CODES, 2020)](https://www.thelancet.com/journals/lanpsy/article/PIIS2215-0366(20)30128-0/fulltext).
...
-   7+ outcome measures used per study (Gaskell et al., unpublished).[^7]

-   FND core outcome battery and specific outcome measures still lacking (for now)

[^7]: Being prepared for publication.

Taken from [Nicholson (2020)](https://neuro.psychiatryonline.org/doi/abs/10.1176/appi.neuropsych.19060128)

![](files/img/outcome.domains.jpg){alt="Taken from Nicholson (2020)"}
