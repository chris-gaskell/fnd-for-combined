...
-   Incongruence. Not about trying to catch them out. This is FND. Complex brain network disorder impacting upon aspects of attention, autonomy and emotion processing.
:::
...
-   Largely seen as a female condition although this effect reduces in late adulthood.

-   Generally consistent with Hansen 2020 pediatric paper which found that across pediatric populations incidence rates is highest in 16-17 years old.
...
-   Approx 22% in a large scale meta-analysis.

LD:

-   A median rate of 9.4% of comorbid ID was found across eleven PNES cohorts (Rawlings et al., 2021).

Demographics:

-   over 50% of all patients live in areas categorised within the highest
    deprivation quintile and over two- thirds of patients being unemployed at the
    point of seeking treatment for PNES (Goldstein *et al.*, 2019).
:::
...
-   MH should be treated irrespective of trauma (however in FND people get used to it).
...
-   Unusual distribution (which doesn't always reflect function).
    ...
    -   1 seizure per month hard to compare against 100 per day at times.
...
-   7+ outcome measures used per study (unpublished study).[^7]

-   Core outcome battery and specific tools still lacking (for now).

[^7]: Results being prepared for publication.
