...
![](files/img/historical.png){.img fig-align="center"}
...
-   Functional vs. Organic debates are outdated and inaccurate dualism.

-   Can a person be non-organic?[^1]
...
[^1]: See excellent video by [John Stone](https://www.youtube.com/watch?v=ersm5f_0LVI&t=21s%22) for more on this.
...
::: columns
::: {.column width="50%"}
-   Neuroimaging in FND is an emerging area[^2].

-   Neurological differences shown in FND[^3].
...
[^2]: Figure taken from from Drane et al (2020)

[^3]: see. [Perez et al (2021)](https://www.sciencedirect.com/science/article/pii/S221315822100067X) for a review
...
Anyone professional who potentially comes into contact with patients has a potential role in identification and/or clarification.
...
::: callout-important
## Key Points Around Diagnosis {background-color="white"}

-   Based on positive clinical signs/symptoms[^4].
...
[^4]: Helpful articles on positive symptoms include [Aybeck, 2022](%22https://drive.google.com/file/d/1YZF-9aHuYeLkgAErzHXx4F-I-rC_2lNq/view) & [Finkelstein et al (2021)](https://onlinelibrary.wiley.com/doi/full/10.1111/acem.14263)
